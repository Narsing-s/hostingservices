...
const oauthMessages: Record<string,string> = {
  github_oauth_unavailable: 'GitHub sign-in is temporarily unavailable. Please try email sign-in or try again later.',
  google_oauth_unavailable: 'Google sign-in is temporarily unavailable. Please try email sign-in or try again later.',
  ...
  github_user_lookup_failed: 'We could not read your GitHub account. Please try again.',
  google_user_lookup_failed: 'We could not read your Google account. Please try again.',
