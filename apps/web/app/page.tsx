...
export default function Home(){
 ...
 async function deploy(){
  ...
  try{
   ...
   const d=await fetch(`${API}/api/v1/deployments`,{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({projectId:project.id,repo:repo||undefined,ref:ref||'main',image:repo?undefined:'nginx:alpine',hostPort:Number(hostPort)||undefined,containerPort:Number(containerPort)||80,healthPath:healthPath||undefined,domain:domain||undefined})});
